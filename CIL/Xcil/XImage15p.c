...
static Caller table[] = {
  ...
  {Char,  XCreateImageFromData_15Planes_Char},
  {Long,  XCreateImageFromData_15Planes_Long},
  {UChar, XCreateImageFromData_15Planes_UChar},
  {UChar3, XCreateImageFromData_15Planes_UChar3},
};
